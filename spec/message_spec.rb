...
#       comment1 = Message.new({:comment => "yas! love!", :author => "Molly", :id => nil})
#       comment2 = Message.new({:comment => "yas! love!", :author => "Molly", :id => nil})
#       expect(comment2).to(eq(comment1))
#     end
#   end
